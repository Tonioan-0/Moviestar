...
public class ResetController {
    ...
    @FXML private TextField newPasswordTextField; // For password visibility toggle
    @FXML private PasswordField confirmPasswordField;
    @FXML private TextField confirmPasswordTextField; // For password visibility toggle

    @FXML private StackPane backToLoginButton;
    @FXML private StackPane parentContainer;
    @FXML private StackPane newPasswordContainer; // Container for new password field with toggle
    @FXML private StackPane confirmPasswordContainer; // Container for confirm password field with toggle

    @FXML private Button resetButton;
    @FXML private Button toggleNewPasswordButton; // Toggle button for new password
    @FXML private Button toggleConfirmPasswordButton; // Toggle button for confirm password
    ...
    private void adjustLayout(double width, double height) {
        ...
        if (mainContainer != null) {
            ...
            if (showContainer) {
                ...
                if (resetButton != null)
                    resetButton.setStyle("-fx-font-size: " + (Math.min(18 * buttonScale, 18)+5) + "px;");// Smaller font size for button
    ...
    private void validatePasswordReset() {
        ...
        try {
            ...
            changePassword(userEmail, hashedPassword);
    ...
    private void changePassword(String email, String hashedPassword) throws SQLException {
    ...
    private void updateStatus(String message) {
        if (statusMessage != null)
            ...
            System.out.println("ResetController: Status message label not found: " + message);
    }
